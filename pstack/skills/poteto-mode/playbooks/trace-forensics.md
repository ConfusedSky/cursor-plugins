...
1. Identify the format and load it with the right tool. Parse large artifacts in a subagent and keep the reduced finding in the main thread; a multi-megabyte trace inlined into your context is the failure mode.
