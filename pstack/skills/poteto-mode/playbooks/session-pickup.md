...
5. Verify the inherited claims against the original goal on the real artifact. You are inheriting unverified work, and a passing prior self-report is not the proof.
